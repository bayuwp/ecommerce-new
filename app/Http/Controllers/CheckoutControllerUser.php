...
class CheckoutControllerUser extends Controller
{
    ...
    public function getProvinces()
    {
        ...
        // Memastikan data provinsi ada
        if (isset($data['rajaongkir']['results'])) {
            $provinces = $data['rajaongkir']['results']; // Data provinsi
        } else {
            $provinces = []; // Jika data tidak ada
        }

        // Mengirimkan data provinsi ke view
        return view('pages.cart.index', compact('provinces'));
    }
