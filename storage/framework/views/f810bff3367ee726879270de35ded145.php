                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="ms-3">
                                        <input type="number" id="quantity-<?php echo e($cart->id); ?>" name="quantity-<?php echo e($cart->id); ?>" class="qty-input bg-gray-50 w-14 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <td>
                                ...
                                data-selected-item-id='<?php echo e($cart->produk->id); ?>'
                                data-selected-item-price='<?php echo e($cart->produk->harga); ?>'
                                data-selected-item-quantity='<?php echo e($cart->quantity); ?>'
                                data-selected-item-name='<?php echo e($cart->produk->nama); ?>'
                                data-amount="<?php echo e($cart->produk->harga * $cart->quantity); ?>" <?php echo e(in_array($cart->id, old('selected_products', [])) ? 'checked' : ''); ?>>
                    ...
                    if (response.status === 'success') {
                        window.snap.pay(response.token, {
                            onSuccess: function(result) {
                                ...
                                console.log(result);
                                $.ajax({
                                    url: "<?php echo e(route('checkout.store')); ?>",
                                    type: 'POST',
                                    data: {
                                        _token: "<?php echo e(csrf_token()); ?>",
